...
public class DatabaseManager {
     ...
     * Purpose: Establishes a connection to the database using credentials retrieved from the DatabaseLoginGUI class.
     */
    ...
    /* Method: insertHike
     *  Parameters: String hikeName, String hikeLocation, double hikeDistance, String hikeDuration,
     *                       int hikeElevation, String hikeDiffLvl
     *  Return: void
     *  Purpose: Inserts a new hike record into the Hikes table in the database.
     */
    ...
    /* Method: deleteHike
     *  Parameters: String hikeName
     *  Return: boolean
     *  Purpose: Deletes the most recent hike record with the specified name from the database. Returns true if a record
    ...
    /* Method: deleteAllHikes
     *  Parameters: none
     *  Return: void
     *  Purpose: Deletes all hike records from the Hikes table in the database.
     */
     ...
     *  Parameters: none
     *  Return: double
     *  Purpose: Calculates and returns the total distance of all hikes from the hike_Distance column in the database.
     */
    ...
    /* Method name: fillTable
     *  Parameters: none
     *  Return: ResultSet
     *  Purpose: Retrieves all hike records from the Hikes table and returns them as a ResultSet.
     */
   public static ResultSet fillTable() throws SQLException {
    ...
    /* Method: addFormTextFile
     *  Parameters: String filePath
     *  Return: boolean
     *  Purpose: Reads hike data from a text file, validates it, and inserts valid records into the database.
     * Returns true if all records are valid and inserted successfully, otherwise false.
     */
    public static boolean addFormTextFile(String filePath){
