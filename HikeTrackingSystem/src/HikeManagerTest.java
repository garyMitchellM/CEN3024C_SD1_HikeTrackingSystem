 ...
 *  This class contains JUnit tests to make sure the functionalities of the system are working as
 * intended. The tests make sure that each CRUD operations perform their intended task as well as the custom
