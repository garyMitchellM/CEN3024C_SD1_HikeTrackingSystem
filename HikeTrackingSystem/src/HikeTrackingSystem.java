 ...
 *  This class contains the main method which creates an instance of the UIController class which constructs the GUI.
 ...
 *  and the main menu will be handled with a graphical user interface using Java Swing.The program will continue to run
 *  until the user chooses to close the program window.
 * */
